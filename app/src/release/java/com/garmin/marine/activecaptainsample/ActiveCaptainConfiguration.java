...
public class ActiveCaptainConfiguration {
    ...
    static final String API_KEY = "PRODUCTION_API_KEY_HERE";
    static final String SSO_URL = "https://sso.garmin.com/sso/embed?clientId=ACTIVE_CAPTAIN_WEB&locale=en_US";
    ...
    static final boolean WEBVIEW_DEBUG = false;
